...
<head>
    ...
    <link rel="stylesheet" href="public/css/editScore.css">
    <script
                ...
                <section class="title">
                    ...
                    <form action="post">
                       <table class="add">
                           ...
                           <tr>
                               <td> Mã môn </td>
                               <td><input type="text" name="idm" style="width:200px" > </td>
                           ...
                           <tr>
                               <td> Điểm 2 </td>
                               <td><input type="text" name="score2" style="width:200px" > </td>
                                
                           </tr>
                           <tr>
                                <td> Điểm 3 </td>
                                <td><input type="text" name="score3" style="width:200px" > </td>
                                
                           </tr>
                           <tr>
                            <td> Điểm TB </td>
                            <td><input type="text" name="avg" style="width:200px" > </td>
